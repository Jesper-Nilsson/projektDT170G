   ...
   //* @GET
    ...
    public Response getOrder(@QueryParam("orderID") int orderID,
        ...
        //check orderID if not given, error or just everything today
            ...
            RestaurantOrderEntity order = entityManager.find(RestaurantOrderEntity.class, orderID);
            order.getPurchasedALaCartesByRestaurantOrderId().size();
            order.getPurchasedDrinksByRestaurantOrderId().size();
